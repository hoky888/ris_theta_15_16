...
if("TRUE" STREQUAL "TRUE")
  set(cob_vision_utils_SOURCE_PREFIX /home/team_theta/ROS/src/cob_perception_common/cob_vision_utils)
  set(cob_vision_utils_DEVEL_PREFIX /home/team_theta/ROS/devel)
  ...
  set(cob_vision_utils_INSTALL_PREFIX /home/team_theta/ROS/install)
...
if(NOT "/home/team_theta/ROS/src/cob_perception_common/cob_vision_utils/common/include;/home/team_theta/ROS/src/cob_perception_common/cob_vision_utils/ros/include;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(cob_vision_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/team_theta/ROS/src/cob_perception_common/cob_vision_utils/common/include;/home/team_theta/ROS/src/cob_perception_common/cob_vision_utils/ros/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cob_vision_utils' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Richard Bormann <rmb@ipa.fhg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'cob_vision_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team_theta/ROS/src/cob_perception_common/cob_vision_utils/${idir}'.  Ask the maintainer 'Richard Bormann <rmb@ipa.fhg.de>' to fix it.")
    endif()
    _list_append_unique(cob_vision_utils_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cob_vision_utils;/usr/lib/x86_64-linux-gnu/libopencv_videostab.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_video.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_superres.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_stitching.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_photo.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_ocl.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_objdetect.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_ml.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_legacy.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_highgui.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_gpu.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_flann.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_features2d.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_core.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_contrib.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_calib3d.so.2.4.8;/usr/lib/x86_64-linux-gnu/libtinyxml.so")
