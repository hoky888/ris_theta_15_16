...
if("TRUE" STREQUAL "TRUE")
  set(zbar_ros_SOURCE_PREFIX /home/team_theta/ROS/src/vicos_ros-master/zbar_ros)
  set(zbar_ros_DEVEL_PREFIX /home/team_theta/ROS/devel)
  set(zbar_ros_INSTALL_PREFIX "")
  set(zbar_ros_PREFIX ${zbar_ros_DEVEL_PREFIX})
else()
  set(zbar_ros_SOURCE_PREFIX "")
  set(zbar_ros_DEVEL_PREFIX "")
  set(zbar_ros_INSTALL_PREFIX /home/team_theta/ROS/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'zbar_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Luka Čehovin <luka.cehovin@fri.uni-lj.si>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'zbar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team_theta/ROS/src/vicos_ros-master/zbar_ros/${idir}'.  Ask the maintainer 'Luka Čehovin <luka.cehovin@fri.uni-lj.si>' to fix it.")
    endif()
...
set(zbar_ros_EXPORTED_TARGETS "zbar_ros_generate_messages_cpp;zbar_ros_generate_messages_lisp;zbar_ros_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${zbar_ros_dep}_FOUND)
      find_package(${zbar_ros_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${zbar_ros_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "zbar_ros-msg-extras.cmake")
