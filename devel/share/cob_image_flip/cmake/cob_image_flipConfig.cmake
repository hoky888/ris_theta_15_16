...
if("TRUE" STREQUAL "TRUE")
  set(cob_image_flip_SOURCE_PREFIX /home/team_theta/ROS/src/cob_perception_common/cob_image_flip)
  set(cob_image_flip_DEVEL_PREFIX /home/team_theta/ROS/devel)
  ...
  set(cob_image_flip_INSTALL_PREFIX /home/team_theta/ROS/install)
...
if(NOT "/home/team_theta/ROS/src/cob_perception_common/cob_image_flip/ros/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(cob_image_flip_INCLUDE_DIRS "")
  set(_include_dirs "/home/team_theta/ROS/src/cob_perception_common/cob_image_flip/ros/include;/usr/include;/usr/include/opencv")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cob_image_flip' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Richard Bormann <richard.bormann@ipa.fraunhofer.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'cob_image_flip' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team_theta/ROS/src/cob_perception_common/cob_image_flip/${idir}'.  Ask the maintainer 'Richard Bormann <richard.bormann@ipa.fraunhofer.de>' to fix it.")
    endif()
    _list_append_unique(cob_image_flip_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_flip_nodelet;/usr/lib/x86_64-linux-gnu/libboost_signals.so;/usr/lib/x86_64-linux-gnu/libopencv_videostab.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_video.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_superres.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_stitching.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_photo.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_ocl.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_objdetect.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_ml.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_legacy.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_highgui.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_gpu.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_flann.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_features2d.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_core.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_contrib.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_calib3d.so.2.4.8")
...
set(depends "cv_bridge;geometry_msgs;image_transport;nodelet;pcl_ros;pcl_conversions;roscpp;sensor_msgs;stereo_msgs;tf")
