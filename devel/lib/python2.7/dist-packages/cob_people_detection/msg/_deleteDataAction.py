...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i.pack(_x.action_goal.goal.delete_mode, _x.action_goal.goal.delete_index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.delete_mode, _x.action_goal.goal.delete_index,) = _struct_2i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
