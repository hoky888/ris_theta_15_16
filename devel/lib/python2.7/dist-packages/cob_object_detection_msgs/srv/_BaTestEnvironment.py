...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_i4fi7f.pack(_x.number_points, _x.frame_view_number, _x.cone_points_per_plane, _x.limit_error_matching, _x.ba_kernel_param, _x.ba_num_iter, _x.ba_initial_mu, _x.ba_final_mu_factor, _x.ba_tau, _x.angle_sigma_degree, _x.translate_sigma_m, _x.obs_point_sigma_m, _x.world_point_sigma_m))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.number_points, _x.frame_view_number, _x.cone_points_per_plane, _x.limit_error_matching, _x.ba_kernel_param, _x.ba_num_iter, _x.ba_initial_mu, _x.ba_final_mu_factor, _x.ba_tau, _x.angle_sigma_degree, _x.translate_sigma_m, _x.obs_point_sigma_m, _x.world_point_sigma_m,) = _struct_i4fi7f.unpack(str[start:end])
      return self
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_8f2i.pack(_x.mean_error, _x.std_dev, _x.min_error, _x.max_error, _x.runs_count, _x.runs_sum, _x.runs_sum2, _x.time_duration, _x.observations, _x.false_matchings))
      _x = self.result.data
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mean_error, _x.std_dev, _x.min_error, _x.max_error, _x.runs_count, _x.runs_sum, _x.runs_sum2, _x.time_duration, _x.observations, _x.false_matchings,) = _struct_8f2i.unpack(str[start:end])
      start = end
      end += 4
